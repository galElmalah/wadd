...
program
  .argument(
    ...
    'The workspaces you want to install a package into, you can pass workspaces separated with by a comma e.g w1,w2,w3 etc, with no white spaces in between',
    ''
  )
  .argument(
    '[packagesToInstall]',
    'Enter the name of the packages you wish to install, to pass several packages just separate them with white space e.g p1 p2 p3...',
    ''
  )
  .option(
    '-d --dev',
    'Passing this flag while install all of the packages as dev dependencies',
    false
  )
